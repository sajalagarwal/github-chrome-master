  ...
  renderSection: (section) ->
    ...
    switch section
      ...
      when 'new-issue'
        ...
        coll.fetch
          success: (mems) =>
            @newIssueView.newmember.reset(mems.models, silent: true)
            @newIssueView.newmember.trigger('reset')
        colle = new MilestoneCollection
          repo: mem
        colle.fetch
          success: (mems) =>
            @newIssueView.newmilestone.reset(mems.models, silent: true)
            @newIssueView.newmilestone.trigger('reset')
